...
class Generate_Data:
    ...
    def Open_effectSize (self):
        ...
        Dir=np.sort(os.listdir(effectSizePath))[2:-2]
        self.Dir=Dir
...
def GetStuff(band,Windows,sampleSize,seed):     
...
plt.close('all')
Data_Alpha,APer_Alpha,Per_Alpha,Ap_Alpha, Par_Alpha = GetStuff('alpha', Windows=50, sampleSize=250,seed=2)
Data_Beta,APer_Beta,Per_Beta,Ap_Beta, Par_Beta = GetStuff('beta', Windows=50, sampleSize=250,seed=2)
