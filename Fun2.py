...
class Generate_Data:
    ...
    def plot_timeSeries(self):
        ...
        plt.fill_between(np.log(freqs),np.log(meanA+stdA),np.log(meanA-stdA),alpha=.5,color='r')
        plt.fill_between(np.log(freqs),np.log(meanB+stdB),np.log(meanB-stdB),alpha=.5,color='g')
